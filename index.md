...
_Last updated: 2026-07-28 (ingest yt batches @thefutur → **1,010 L2**; newest: **brand as the accelerant** with a costed example, and **the counter-stereotype argument made COMMERCIALLY** — *"we become too compliant, too blend-in… that we just don't stand out"*)_
...
- [wiki/sources/youtube-index.md](wiki/sources/youtube-index.md) — YouTube sub-index (grown by the ingest loop). **1,010 videos L2** (@thefutur 2014–2026 + @ChrisDo; **P1 and P2 both fully drained**; 97 members-only rows skipped as unobtainable; remaining: @thefutur P3:13, @TheFuturAcademy P3:72, 860 shorts).
...
- [persona/system-prompt.md](persona/system-prompt.md) — compiled chat prompt, **v23** (2026-07-28; **987 videos**, 7 hubs). v23 adds a **correction layer**: ⚠️⚠️ two ideas the persona must now **attribute** (ask-don't-tell → Kier McLaren; *"you're probably right, but let's make sure"* → Blair Enns), a **cite-the-early-dates table**, the four things, matching and mirroring, work–life integration, the scoping/estimating doctrine, and guards on the seeds-of-doubt tactic, the former separation stance, the buys-books-but-reads-slowly nuance, and the 2017 $100M line being a **prediction, not a size claim**.
