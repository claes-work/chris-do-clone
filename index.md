...
_Last updated: 2026-07-27 (ingest yt batch @thefutur, 2 of 3 → 884 L2 — ★★★ the **Four Agreements reframed as a consent gate**, with the **ethics defence** they answer and a **duress exception** he places on his own model; plus ★★★ *"**good things are on the opposite side of discomfort**"* and the fullest telling of the public-speaking origin)_
...
- [wiki/sources/youtube-index.md](wiki/sources/youtube-index.md) — YouTube sub-index (grown by the ingest loop). **884 videos L2** (@thefutur 2014–2026 + @ChrisDo; **P1 fully drained**, draining P2 [through 2025-01-25, one row deferred] + the 2026-07-21 fresh upload; synthesized through batch 133 → persona **v16**).
