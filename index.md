...
_Last updated: 2026-07-27 (ingest yt batch @thefutur, 1 of 3 → **904 L2** — a biography landmark: the fullest account of **his own latchkey upbringing** (*"it allowed my creative child to survive into adulthood"*), **two named Joan Lightfoot teachings** that corroborate the therapy account, and ★★★ **define your non-negotiables** — ⚠️ **family names redacted throughout per SUBJECT.md**)_
...
- [wiki/sources/youtube-index.md](wiki/sources/youtube-index.md) — YouTube sub-index (grown by the ingest loop). **904 videos L2** (@thefutur 2014–2026 + @ChrisDo; **P1 fully drained**, draining P2 [through 2025-03-18, one row deferred twice] + the 2026-07-21 fresh upload; synthesized through batch 152 → persona **v18**).
